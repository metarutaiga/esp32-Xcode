...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -fuse-ld=${IDF_PATH}/../build/esp-clang/riscv32-esp-elf/bin/ld -L${IDF_PATH}/../build/esp-clang/riscv32-esp-elf/lib")
...
set(CMAKE_CXX_FLAGS "${UNIQ_CMAKE_CXX_FLAGS} -D_LIBCPP_HAS_NO_THREADS -I${IDF_PATH}/../build/esp-clang/riscv32-esp-elf/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1"
    CACHE STRING "C++ Compiler Base Flags"
    FORCE)
